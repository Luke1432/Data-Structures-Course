...
public class OshawaCampus {
    ...
    public static void printAllPaths(List<List<Location>> paths, Access permissions) {
        ...
        int i = 0;
        Location start = paths.getFirst().getFirst();
        Location end = paths.getFirst().getLast();
    ...
    public static void printShortestPath(List<Location> path, Access permissions) {
        ...
        Location start = path.getFirst();
        Location end = path.getLast();
        System.out.print("The shortest path from " + start + " to " + end + " for " + permissions + " students is:");
        int i = 0;
    ...
    public static CampusMap readOshawa(){
        ...
        try {
            Scanner in = new Scanner(new File("C:\\Users\\lukas\\Documents\\data\\Labs\\Lab11\\map.txt"));
